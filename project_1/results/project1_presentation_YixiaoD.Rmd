...
```
For people that come again, there are 10790 in total, we predict 7666 correctly. The true positive rate is 0.71.  
For people that not come again, there are 2668 in total, we predict 1710 correctly. The negtive rate is 0.64.  
...
3. By using XGBoost, we can accurately predict predict whether a client will come again based on the aid he get in this visit and the imformation about his previous visits. (we can give a probability) Accuracy:0.70, True Positive Rate:0.71, True Negtive Rate:0.64.
